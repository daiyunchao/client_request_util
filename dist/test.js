...
var requestUtils = function () {
    ...
    function requestUtils(_ref) {
        var _ref$hostName = _ref.hostName,
            ...
            _ref$defaultHeader = _ref.defaultHeader,
            defaultHeader = _ref$defaultHeader === undefined ? {} : _ref$defaultHeader,
            _ref$defaultAddParams = _ref.defaultAddParams,
            defaultAddParams = _ref$defaultAddParams === undefined ? {} : _ref$defaultAddParams,
            _ref$isPrintLog = _ref.isPrintLog,
            isPrintLog = _ref$isPrintLog === undefined ? true : _ref$isPrintLog,
            _ref$defaultCallback = _ref.defaultCallback,
            defaultCallback = _ref$defaultCallback === undefined ? null : _ref$defaultCallback;
    ...
    _createClass(requestUtils, [{
        key: 'postByApplicationJson',
        value: function postByApplicationJson(_ref2) {
            var postURL = _ref2.postURL,
                _ref2$isCompleteUrl = _ref2.isCompleteUrl,
                isCompleteUrl = _ref2$isCompleteUrl === undefined ? false : _ref2$isCompleteUrl,
                _ref2$newHeader = _ref2.newHeader,
                newHeader = _ref2$newHeader === undefined ? null : _ref2$newHeader,
                _ref2$addDefaultHeade = _ref2.addDefaultHeader,
                addDefaultHeader = _ref2$addDefaultHeade === undefined ? false : _ref2$addDefaultHeade,
                _ref2$postArgs = _ref2.postArgs,
                postArgs = _ref2$postArgs === undefined ? {} : _ref2$postArgs,
                _ref2$addDefaultArgs = _ref2.addDefaultArgs,
                addDefaultArgs = _ref2$addDefaultArgs === undefined ? true : _ref2$addDefaultArgs,
                _ref2$callback = _ref2.callback,
                callback = _ref2$callback === undefined ? function () {} : _ref2$callback,
                _ref2$beforeDoDefault = _ref2.beforeDoDefaultCallBack,
                beforeDoDefaultCallBack = _ref2$beforeDoDefault === undefined ? true : _ref2$beforeDoDefault;
            ...
            (0, _isomorphicFetch2.default)(requestUrl, {
                method: "POST",
        ...
        key: 'encodeObject',
        value: function encodeObject(sourceObj) {
        ...
        value: function changeObjectValue(_ref3) {
            var changeObj = _ref3.changeObj,
                changeKey = _ref3.changeKey,
                newValue = _ref3.newValue;

            var found = false;
            for (var item in changeObj) {
                //如果key相同,则进行替换:
        ...
        key: 'mergeObject',
        value: function mergeObject(_ref4) {
            var oldObj = _ref4.oldObj,
                newObj = _ref4.newObj;
